...
export const appThemes: AppThemeDefinition[] = [
  ...
  },
  {
    ...
    globe: {
      ...
      surfaceDistortionStrength: 1.05,
      surfaceTextureStrength: 1.15,
    },
    qualityDefaults: {
      reliefMapEnabled: true,
      reliefHeight: 1,
  ...
  },
  {
    ...
    qualityDefaults: {
      ...
      waterMaskEnabled: false,
      cityLightsEnabled: true,
      cityLightsIntensity: 2.55,
      cityLightsThreshold: 0.025,
      cityLightsGlow: 1.95,
      cityLightsColor: '#9ffcff',
      lightPollutionEnabled: true,
      lightPollutionIntensity: 1.1,
      lightPollutionSpread: 2.6,
