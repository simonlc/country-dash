...
const globeRenderControlDefinitions = [
  ...
  { key: 'atlasParchmentAgingEnabled', kind: 'boolean', group: ['Atlas'] },
  { key: 'atlasWatercolorOceanEnabled', kind: 'boolean', group: ['Atlas'] },
  { key: 'atlasWatercolorLandEnabled', kind: 'boolean', group: ['Atlas'] },
  { key: 'atlasBiomeWatercolorEnabled', kind: 'boolean', group: ['Atlas'] },
  { key: 'atlasOceanCurrentHatchingEnabled', kind: 'boolean', group: ['Atlas'] },
  { key: 'atlasCoastalWashEnabled', kind: 'boolean', group: ['Atlas'] },
  { key: 'atlasInkCoastlineEnabled', kind: 'boolean', group: ['Atlas'] },
  { key: 'atlasInkBleedEnabled', kind: 'boolean', group: ['Atlas'] },
  { key: 'atlasExpeditionDetailsEnabled', kind: 'boolean', group: ['Atlas'] },
  { key: 'atlasGraticuleStrokeEnabled', kind: 'boolean', group: ['Strokes', 'Atlas'] },
  {
  ...
  { key: 'cipherHydroTextureEffectEnabled', kind: 'boolean', group: ['Cipher'] },
  { key: 'cipherHydroOverlayEnabled', kind: 'boolean', group: ['Cipher'] },
  { key: 'cipherTrafficOverlayEnabled', kind: 'boolean', group: ['Cipher'] },
  { key: 'cipherSelectedCountryOverlayEnabled', kind: 'boolean', group: ['Cipher'] },
  { key: 'cipherMapAnnotationsEnabled', kind: 'boolean', group: ['Cipher'] },
  { key: 'cipherCountryTransitionEnabled', kind: 'boolean', group: ['Cipher'] },
  { key: 'cipherScreenTransitionOverlayEnabled', kind: 'boolean', group: ['Cipher'] },
  {
